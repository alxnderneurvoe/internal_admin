...
<tr><td>Perihal</td><td>: Surat Penawaran Harga</td></tr>
</table>
...
$catatan = [];
$catatan[] = 'Penawaran ini berlaku 10 hari setelah penawaran dibuat';
$catatan[] = 'Harga dapat berubah sewaktu-waktu';

if ($invoice['shipping'] >= 1) {
    $catatan[] = 'Harga sudah termasuk ongkir';
} else {
    $catatan[] = 'Harga belum termasuk ongkir';
}

if ($invoice['delivery_time'] >= 1) {
    $catatan[] = 'Estimasi Pengiriman : ' . $invoice['delivery_time'] . ' ' . $invoice['delivery_unit'] . ' setelah pembayaran';
}

$catatan[] = 'Pembayaran dapat dilakukan sejak invoice diterbitkan';
$catatan[] = 'Untuk pemesanan lebih lanjut hubungi <strong>PT SEMESTA SISTEM SOLUSINDO</strong><br>+62 811-1933-077 (Rahmad Saputra)';

$html .= '<div class="note"><p>Catatan :</p><ol>';
