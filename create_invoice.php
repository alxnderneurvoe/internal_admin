...
<div class="container">
    ...
    <form action="create_letter.php" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" name="client_name" id="client_name" class="form-control" placeholder="XXXX XXXX XXXX XXXX" 
                ...
                <tr>
                    <th>
                        <div>
                            ...
                            <p>Pajak (11%): <span id="tax">0</span></p>
                            <p>Ongkir: <span id="shipping">0</span></p>
        ...
        <tr>
            ...
            <th>
                <div class="form-group">
                    ...
                    <input type="number" name="pajak" id="pajak" class="form-control" style="background-color: grey; opacity: calc(0.3);" readonly>
                </div> 
            </th>
            <th>
                <div class="form-group">
                    <label for="ongkir">Ongkir</label>
                    <input type="number" name="ongkir" id="ongkir" class="form-control" style="background-color: grey; opacity: calc(0.3);" value="0" oninput="updateGrandTotal()">
                </div> 
            </th>
        </tr>
        <tr>
            <th colspan="3">
                <div class="form-group">
                    ...
                    <input type="number" name="grand_total" id="grand_total" class="form-control" style="background-color: grey; opacity: calc(0.3);" readonly>
                </div> 
            </th>
        </tr>
    </tbody>
...
<script>
  ...
  function updateTotal() {
        ...
        // Menghitung pajak (misalnya 10%)
        var taxRate = 0.11;  // 10% pajak
        var tax = subtotal * taxRate;

        // Menghitung ongkir (misalnya ongkir tetap 50)
        // Menghitung grandtotal
        var grandtotal = subtotal + tax + shipping;

        // Memperbarui nilai subtotal, pajak, ongkir dan grandtotal
        document.getElementById('subtotal').innerText = subtotal.toFixed(0);
        document.getElementById('tax').innerText = tax.toFixed(0);
        document.getElementById('shipping').innerText = shipping.toFixed(0);
